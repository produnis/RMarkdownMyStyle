...
Wenn Sie jetzt knitten, sieht die PDF-Datei so aus:

![(#fig:latex3)fertiges PDF-Dokument](images/LaTeX-PDF2.png){width="800"}

Jetzt können Sie noch weitere Anpassungen vornehmen. Wenn Sie fertig sind, entfernen Sie die PDF-Datei und bauen und installieren Sie das Paket neu. Ab jetzt steht es in `RStudio` als Vorlage zur Verfügung.
